...
function App() {
  ...
  const [messages, setMessages] = useState<Message[]>([
    { role: 'noa', text: 'Hey John - Noah is online. Alpha 1.0 adds Workspace Intelligence - daily briefings, task focus, upcoming jobs and client-aware Notion summaries.', source: 'local' }
  ]);
      ...
      <section className="workspace">
        <header className="topbar">
          ...
          <div className="top-actions">
            ...
            <div className="status-pill muted"><Lock size={16} />Alpha 1.0</div>
          </div>
        </header>
