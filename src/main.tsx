...
import { Activity, ArrowUpRight, Brain, CheckCircle2, Command, Cpu, Database, DownloadCloud, Gauge, KeyRound, Loader2, Lock, MessageSquareText, PlugZap, Send, Shield, Sparkles, TerminalSquare, Wifi, WifiOff } from 'lucide-react';
...
function App() {
  ...
  const [messages, setMessages] = useState<Message[]>([
    { role: 'noa', text: 'Hey John - Noah is online. Alpha 0.9 adds the first real Notion bridge for tasks and jobs, alongside weather, web lookup, memory and OpenAI.', source: 'local' }
  ]);
      ...
      <section className="workspace">
        <header className="topbar">
          ...
          <div className="top-actions">
            ...
            <div className="status-pill muted"><Lock size={16} />Alpha 0.9</div>
          </div>
        </header>
